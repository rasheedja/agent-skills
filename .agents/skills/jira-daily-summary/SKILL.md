...
description: "Summarize one user's daily Jira activity, including completed work, status changes, created issues, and comments."
---
...
**Prerequisites:** **[jira-acli](../jira-acli/SKILL.md)** — you need `acli` authenticated and the JQL/search/view commands from that skill.
...
Use **acli** from [jira-acli](../jira-acli/SKILL.md).
...
For the mechanics of acli (JQL, view, comment list), always use **[jira-acli](../jira-acli/SKILL.md)**.
