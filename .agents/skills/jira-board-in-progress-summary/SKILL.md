---
name: jira-board-in-progress-summary
description: "Summarize a Jira board's currently in-progress issues grouped by assignee. Use for a current snapshot rather than today's activity."
---
...
**Prerequisites:** **[jira-acli](../jira-acli/SKILL.md)** — `acli` authenticated and JQL search.

---

## 1. Scope

- **Board** — Identified by Jira **project** key. Use `acli jira board search` to find the board and its project key (see **[jira-board-team-daily-summary](../jira-board-team-daily-summary/SKILL.md)** §2).
...
For acli and JQL details, see **[jira-acli](../jira-acli/SKILL.md)**. For daily team updates on the same board, see **[jira-board-team-daily-summary](../jira-board-team-daily-summary/SKILL.md)**.
