---
name: jira-board-team-daily-summary
description: "Summarize today's Jira board activity across the team, grouped by assignee."
---
...
**Prerequisites:** **[jira-acli](../jira-acli/SKILL.md)** — `acli` authenticated; **[jira-daily-summary](../jira-daily-summary/SKILL.md)** for the per-person presentation pattern (Done, In review/ready, In progress, New work).
...
Use **acli** from [jira-acli](../jira-acli/SKILL.md). Replace `<KEY>` with the target board’s project key.
...
For JQL and acli usage, see **[jira-acli](../jira-acli/SKILL.md)**. For the per-person status grouping pattern, see **[jira-daily-summary](../jira-daily-summary/SKILL.md)**.
