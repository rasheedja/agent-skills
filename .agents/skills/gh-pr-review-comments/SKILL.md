...
description: "Use GitHub CLI and API to inspect PR review comments and threads, reply, and resolve threads when authorized. Covers mechanics rather than review strategy."
---
