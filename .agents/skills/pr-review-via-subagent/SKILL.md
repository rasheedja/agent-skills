---
name: pr-review-via-subagent
description: "Delegate independent review of an existing PR to a subagent and follow the review-to-address workflow."
---
...
**[jira-to-pr-review](../jira-to-pr-review/SKILL.md)**, or any PR the user points you at.
...
test coverage), the reviewer should apply **[conducting-code-review](../conducting-code-review/SKILL.md)**. For the **iterative
loop** (subagent reviews → main agent triages and fixes → repeat until clean), see
**[subagent-review-main-agent-address](../subagent-review-main-agent-address/SKILL.md)** — this skill is the "spin up the reviewer" half of
that loop. For **posting** the findings as GitHub comments (only if asked), see
**[gh-pr-review-comments](../gh-pr-review-comments/SKILL.md)**.
...
2. **Check correctness.** Bugs, wrong logic, unhandled edge cases, error/empty/failure paths, race
   conditions, off-by-ones — apply **[conducting-code-review](../conducting-code-review/SKILL.md)**.
...
**[subagent-review-main-agent-address](../subagent-review-main-agent-address/SKILL.md)** for the triage rules and the review→address→re-review
...
5. Read the report; triage with full context; fix what matters; loop if needed
   (§6, **[subagent-review-main-agent-address](../subagent-review-main-agent-address/SKILL.md)**).
...
| Topic | Skill |
|-------|-------|
| What a review pass evaluates (criteria) | **[conducting-code-review](../conducting-code-review/SKILL.md)** |
| Review → triage → fix → re-review loop | **[subagent-review-main-agent-address](../subagent-review-main-agent-address/SKILL.md)** |
| Producing the PR a reviewer then checks | **[jira-to-pr-review](../jira-to-pr-review/SKILL.md)** |
| Posting findings as PR comments | **[gh-pr-review-comments](../gh-pr-review-comments/SKILL.md)** |
| Replying to existing review comments | **[performing-reviews](../performing-reviews/SKILL.md)** |
