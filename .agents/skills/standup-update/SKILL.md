---
name: standup-update
description: "Draft a concise standup update from GitHub and Jira activity, grouped by project with next steps and blockers."
---
...
**Prerequisites:**
- **[jira-daily-summary](../jira-daily-summary/SKILL.md)** — the JQL queries for "my activity today" live there; don't duplicate them.
...
Use **[jira-daily-summary](../jira-daily-summary/SKILL.md)** §2 (JQL A + B):
...
3. Run Jira JQL A + B (see **[jira-daily-summary](../jira-daily-summary/SKILL.md)**).
...
- **"Updated" in Jira includes changes made by others** (e.g. someone else moving the user's ticket). The summary is "my assigned tickets that saw activity today", not strictly "changes I personally made" — [jira-daily-summary](../jira-daily-summary/SKILL.md) §6 has the same caveat.
